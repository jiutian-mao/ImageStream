...
void HttpConnection::SetProgressCallBack(void* ptr, ProgressFunction progress_fun)
{
    setCurlOption(CURLOPT_NOPROGRESS, false);
    setCurlOption(CURLOPT_PROGRESSFUNCTION, progress_fun);
